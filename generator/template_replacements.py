...
THUMBNAIL_IMAGE = "https://static.wikia.nocookie.net/gensin-impact/images/e/e3/Splashscreen_Everwinter_Without_Mercy.png"
...
def generate_characters_page():
    ...
    replace = r"""<template x-for="{ char, form } in cellRows(\1)">
        <div @click="showCharSheet(char.name, form)" class="character-links">
            <img width="20" height="20" :src="photoUrl(form.photo || char.photo)">
